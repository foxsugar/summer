...
public class PokerItem {
	...
	public static boolean isYSZ = false;
	public PokerItem() {		
	}
	...
	public static int ShunJinCompare(Player p1, Player p2){
		...
		if (isYSZ){
			return PokerYSZ.ShunJinCompare(p1, p2);
		}
	...
	public static int shunZiCompare(Player p1, Player p2){
		...
		if (isYSZ){
			return PokerYSZ.shunZiCompare(p1, p2);
		}
