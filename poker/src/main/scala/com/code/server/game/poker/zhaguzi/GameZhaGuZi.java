...
//        vo.cards.clear();
    ...
    public void talkStart(long userId){
        ...
        MsgSender.sendMsg2Player(serviceName, "talkStart", result, userId);
    }
...
//        //提示出牌
        MsgSender.sendMsg2Player(serviceName, "discardStart", player.toVo(), player.userId);
