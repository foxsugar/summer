...
public class GameGoldYSZ extends Game {
    protected static final Logger logger = LoggerFactory.getLogger(GameGoldYSZ.class);
...
//            }
    ...
    public GameGoldYSZ setRoom(RoomYSZ room) {
        this.room = room;
        return this;
    }
