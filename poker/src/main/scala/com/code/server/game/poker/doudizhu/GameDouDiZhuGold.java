 ...
 */
public class GameDouDiZhuGold extends Game {
    private static final Logger logger = LoggerFactory.getLogger(GameDouDiZhuGold.class);
    ...
    protected Map<Long, PlayerCardInfoDouDiZhuGold> playerCardInfos = new HashMap<>();
    ...
    public void init(List<Long> users, long dizhuUser) {
        //初始化玩家
        for (Long uid : users) {
            PlayerCardInfoDouDiZhuGold playerCardInfo = getGameTypePlayerCardInfo();
    ...
    public PlayerCardInfoDouDiZhuGold getGameTypePlayerCardInfo() {
        return new PlayerCardInfoDouDiZhuGold();
    }
    ...
    public int play(long userId, CardStruct cardStruct) {
        PlayerCardInfoDouDiZhuGold playerCardInfo = playerCardInfos.get(userId);
        //不可出牌
        ...
        if (playerCardInfo.cards.size() == 0) {
            PlayerCardInfoDouDiZhuGold playerCardInfoDizhu = playerCardInfos.get(dizhu);
            //是否是春天
...
//        userId.sendMsg("gameService", "play", 0);
     ...
     */
    protected void deal() {
        for (PlayerCardInfoDouDiZhuGold playerCardInfo : playerCardInfos.values()) {
    ...
    protected void genRecord() {
        ...
        genRecord(playerCardInfos.values().stream().collect
                (Collectors.toMap(PlayerCardInfoDouDiZhuGold::getUserId, PlayerCardInfoDouDiZhuGold::getScore)), room, id);
    ...
    protected void dizhuAddTableCards(){
        //把底牌加到地主身上
        PlayerCardInfoDouDiZhuGold playerCardInfo = playerCardInfos.get(dizhu);
    ...
    protected void doAfterStart(){
        //玩家所有的牌
        for(PlayerCardInfoDouDiZhuGold playerCardInfoDouDiZhu : playerCardInfos.values()){
    ...
    public IfaceGameVo toVo(long userId) {
        ...
        if (userId == this.getDizhu()) {//玩家是地主 并且是临汾斗地主
            vo.tableCards.addAll(this.getTableCards());
        }


        //玩家牌信息
        for (PlayerCardInfoDouDiZhuGold playerCardInfo : this.getPlayerCardInfos().values()) {
    ...
    public GameDouDiZhuGold setCards(List<Integer> cards) {
        this.cards = cards;
        return this;
    }
    ...
    public GameDouDiZhuGold setDisCards(List<Integer> disCards) {
    ...
    public GameDouDiZhuGold setTableCards(List<Integer> tableCards) {
        this.tableCards = tableCards;
        return this;
    }

    public Map<Long, PlayerCardInfoDouDiZhuGold> getPlayerCardInfos() {
        return playerCardInfos;
    }

    public GameDouDiZhuGold setPlayerCardInfos(Map<Long, PlayerCardInfoDouDiZhuGold> playerCardInfos) {
    ...
    public GameDouDiZhuGold setUsers(List<Long> users) {
        this.users = users;
        return this;
    }
    ...
    public GameDouDiZhuGold setRand(Random rand) {
        this.rand = rand;
        return this;
    }
    ...
    public GameDouDiZhuGold setDizhu(long dizhu) {
        this.dizhu = dizhu;
        return this;
    }
    ...
    public GameDouDiZhuGold setChooseJiaoSet(Set<Long> chooseJiaoSet) {
    ...
    public GameDouDiZhuGold setChooseQiangSet(Set<Long> chooseQiangSet) {
    ...
    public GameDouDiZhuGold setBujiaoSet(Set<Long> bujiaoSet) {
    ...
    public GameDouDiZhuGold setLasttype(int lasttype) {
    ...
    public GameDouDiZhuGold setCanJiaoUser(long canJiaoUser) {
    ...
    public GameDouDiZhuGold setCanQiangUser(long canQiangUser) {
    ...
    public GameDouDiZhuGold setJiaoUser(long jiaoUser) {
    ...
    public GameDouDiZhuGold setQiangUser(long qiangUser) {
    ...
    public GameDouDiZhuGold setPlayTurn(long playTurn) {
    ...
    public GameDouDiZhuGold setLastCardStruct(CardStruct lastCardStruct) {
    ...
    public GameDouDiZhuGold setStep(int step) {
        this.step = step;
        return this;
    }
    ...
    public GameDouDiZhuGold setMultiple(int multiple) {
    ...
    public GameDouDiZhuGold setTableScore(int tableScore) {
