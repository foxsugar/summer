 ...
 */
public class PlayerCardInfoDouDiZhuGold implements IfacePlayerInfo {
    ...
    public PlayerCardInfoDouDiZhuGold setUserId(long userId) {
        this.userId = userId;
        return this;
    }
    ...
    public PlayerCardInfoDouDiZhuGold setCards(List<Integer> cards) {
        this.cards = cards;
        return this;
    }
    ...
    public PlayerCardInfoDouDiZhuGold setDisCards(List<Integer> disCards) {
    ...
    public PlayerCardInfoDouDiZhuGold setQiang(boolean qiang) {
        isQiang = qiang;
        return this;
    }
    ...
    public PlayerCardInfoDouDiZhuGold setScore(double score) {
        this.score = score;
        return this;
    }
    ...
    public PlayerCardInfoDouDiZhuGold setPlayCount(int playCount) {
    ...
    public PlayerCardInfoDouDiZhuGold setAllCards(List<Integer> allCards) {
