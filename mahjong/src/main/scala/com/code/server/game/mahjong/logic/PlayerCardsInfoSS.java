...
public class PlayerCardsInfoSS extends PlayerCardsInfoMj {
	...
	public static void main(String[] args) {
		PlayerCardsInfoSS playerCardsInfoKD = new PlayerCardsInfoSS();
	...
	public void huCompute(RoomInfo room, GameInfo gameInfo, boolean isZimo,
		...
		if (isZimo) {// 自摸
			if (room.getModeTotal().equals("13") && (
    			...
    			room.setUserSocre(this.userId, 2 * room.getPersonNumber() * room.getMultiple());
    			this.fan = 2;
			} else if (room.getModeTotal().equals("13") && (
