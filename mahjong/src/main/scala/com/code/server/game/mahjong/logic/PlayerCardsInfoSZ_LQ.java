...
public class PlayerCardsInfoSZ_LQ extends PlayerCardsInfoSZ {
    ...
    public void init(List<String> cards) {
        ...
        specialHuScore.remove(hu_门清,1);
        specialHuScore.remove(hu_清一色,10);
        specialHuScore.remove(hu_一条龙,10);
        specialHuScore.remove(hu_七小对,10);
        specialHuScore.remove(hu_豪华七小对,25);
        specialHuScore.remove(hu_双豪七小对_山西,50);
        specialHuScore.remove(hu_字一色,50);
        specialHuScore.remove(hu_清七对,50);
        specialHuScore.remove(hu_清龙,50);
