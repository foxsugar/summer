...
/*        specialHuScore.put(hu_边张,1);
    ...
    public boolean isCanHu_dianpao(String card) {
        ...
        return HuUtil.isHu(noPengAndGang, this, cardType, new HuLimit(Integer.parseInt(roomInfo.getMode()))).size() > 0;
    }
    ...
    public boolean isCanHu_zimo(String card) {
        ...
        yiZhangyingSet = getYiZhangYingSet(getCardsNoChiPengGang(cards), null);
        int cardType = CardTypeUtil.cardType.get(card);
        return HuUtil.isHu(cs, this,cardType , new HuLimit(Integer.parseInt(roomInfo.getMode()))).size()>0;
    }
    ...
    public boolean isCanTing(List<String> cards) {
        ...
        if(!roomInfo.isHaveTing()){
            ...
            int needFan = Integer.parseInt(roomInfo.getMode());
