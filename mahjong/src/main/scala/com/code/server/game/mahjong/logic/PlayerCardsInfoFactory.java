    ...
    public static PlayerCardsInfoMj getInstance(RoomInfo room) {
        ...
        switch (model) {
            ...
            case "115":
                ...
                break;
            case "116":
                playerCardsInfo = new PlayerCardsInfoTDH51();
                break;
            case "117":
                playerCardsInfo = new PlayerCardsInfoXZDD();
                break;
            case "118":
                playerCardsInfo = new PlayerKDLongcheng();
                break;
            case "121":
                playerCardsInfo = new PlayerCardsInfoLingchuan();
                break;
            default:
